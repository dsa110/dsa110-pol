...
#"pol_self_calibs_FORPAPER/" #"/dataz/dsa110/operations/beamformer_weights/generated" #"/dataz/dsa110/operations/beamformer_weights/applied" #"/home/ubuntu/sherman/pol_calibs"
...
echo ${mjd}
calibdate="$4" #"$4_$5"
outdir="${DSAFRBDIR}$3_$5" #"/media/ubuntu/ssd/sherman/scratch_weights_update_2022-06-03_32-7us/$3_$4"
mkdir ${outdir}
echo $1 $2 $3 $4 $5
for i in ${!corrs[@]}; do

    #dir="/media/ubuntu/ssd/sherman/$3_$4/${corrs[$i]}"
    dir="${DSACALDIR}$5/$3/${corrs[$i]}"

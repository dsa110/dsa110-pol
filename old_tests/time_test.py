...
def main():
    ...
    test_time_ideal_test_1()
    test_time_ideal_test_2()
    test_time_ideal_test_3()
    test_time_ideal_test_4()
    test_time_ideal_test_5()
    test_time_ideal_test_6()
    test_time_noisy_test_1()
    test_time_noisy_test_2()
    test_time_noisy_test_3()
    test_time_noisy_test_4()
    test_time_noisy_test_5()
    test_time_noisy_test_6()

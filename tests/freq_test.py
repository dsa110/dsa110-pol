...
def main():
    ...
    test_freq_ideal_test_1()
    test_freq_ideal_test_2()
    test_freq_ideal_test_3()
    test_freq_ideal_test_4()
    test_freq_ideal_test_5()
    test_freq_ideal_test_6()
    test_freq_noisy_test_1()
    test_freq_noisy_test_2()
    test_freq_noisy_test_3()
    test_freq_noisy_test_4()
    test_freq_noisy_test_5()
    test_freq_noisy_test_6()
    test_binning_test()
